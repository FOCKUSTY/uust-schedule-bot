...
export const help = async (ctx: Context) => {
  ...
  builder
    ...
    .appendLine()
    .append("• 💟 – показатель основной группы (для выбора основной группы нажать на название группы)")
    .appendLine()
    .appendLine()
    .bold("ℹ️ Примечания")
    .appendLine()
    .append("• Расписание обновляется автоматически при изменениях в Google Drive")
    .appendLine()
