import { getDateFromWeekNumber, type ScheduleDay, type ScheduleWeek } from "../../schedule";
...
export const formatDay = (day: ScheduleDay, weekNumber: number): string => {
  const date = getDateFromWeekNumber(weekNumber, DAY_NAMES_RU.indexOf(day.dayName));
